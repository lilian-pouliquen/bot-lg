...
(async () => {
	try {
		createLog('global', 'bot-lg', 'info', `Started refreshing ${commands.length} application commands`);
		...
		createLog('global', 'bot-lg', 'info', `Successfully reloaded ${data.length} application commands`);
	} catch (error) {
		console.error(error);
